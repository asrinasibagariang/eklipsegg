...
WebUI.setText(findTestObject('AccountSettings/Page_Eklipse/input_Name_Name'), 'test')

WebUI.setText(findTestObject('AccountSettings/Page_Eklipse/input_Email_Email'), 'testeklipse@yopmail.com')
