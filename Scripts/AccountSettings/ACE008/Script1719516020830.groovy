...
WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/li_Personal Details'))

WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/button_Change Password'))

WebUI.setEncryptedText(findTestObject('Object Repository/AccountSettings/Page_Eklipse/input_Current password_currentPassword'), 
    'fzqqY0qJjYRVrxTAfQ5f7A==')

WebUI.setEncryptedText(findTestObject('Object Repository/AccountSettings/Page_Eklipse/input_New password_newPassword'), 
    'P9ET2sDE0SE=')

WebUI.setEncryptedText(findTestObject('Object Repository/AccountSettings/Page_Eklipse/input_Confirm password_confirmPassword'), 
    'P9ET2sDE0SE=')

WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/button_Save Changes'))

WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/button_Continue'))
