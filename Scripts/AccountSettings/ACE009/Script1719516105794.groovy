...
WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/button_Delete Account'))

WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/button_Continue'), FailureHandling.STOP_ON_FAILURE)
