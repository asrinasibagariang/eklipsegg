...
WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/li_Plugin Setting'))

WebUI.verifyElementPresent(findTestObject('Object Repository/AccountSettings/Page_Eklipse/li_Plugin Setting'), 0)
