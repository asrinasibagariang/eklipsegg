...
WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/li_Premium Plan'))

WebUI.verifyElementPresent(findTestObject('Object Repository/AccountSettings/Page_Eklipse/h4_Subscriptions and Credits'), 
    0)
