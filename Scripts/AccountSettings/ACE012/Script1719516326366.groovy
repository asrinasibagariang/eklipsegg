...
WebUI.click(findTestObject('Object Repository/AccountSettings/Page_Eklipse/p_Game Setting'))

WebUI.verifyElementPresent(findTestObject('Object Repository/AccountSettings/Page_Eklipse/p_Gamer Name'), 0)
