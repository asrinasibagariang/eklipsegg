...
WebUI.setText(findTestObject('Object Repository/Register/Page_Eklipse/input_OR_email'), 'test@testing.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/Page_Eklipse/input_OR_password'), 'fzqqY0qJjYRVrxTAfQ5f7A==')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/Page_Eklipse/input_OR_password_confirmation'), 'P9ET2sDE0SE=')
